...
const features = [
  {
    ...
    description:
      "Get instant answers to your financial questions through our intelligent chat system.",
    image: "/assets/generated/ai-guidance-icon-transparent.dim_64x64.png",
  },
  {
    title: "Expert Human Advisors",
    description:
      "Book calls with certified financial advisors for personalized, in-depth guidance.",
    image: "/assets/generated/expert-call-icon-transparent.dim_64x64.png",
  },
  {
    title: "Actionable Plans",
    description:
      "Receive clear, step-by-step action plans tailored to your financial goals.",
      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            We've built a financial advisory service that puts your interests
            first—no conflicts, no compromises.
          </p>
        </div>
